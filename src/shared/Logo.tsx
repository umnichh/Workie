...
export default function Logo({isWhiteTheme, logoWidth, logoHeight, nameHeight, nameWidth}: LogoProps) {
  return (
    <a href="https://www.youtube.com/watch?v=SuyDe1VXaEk&ab_channel=FACE-Topic" className="logo">
      ...
      <LogoNameSvg width={nameHeight} height={nameWidth ? nameWidth : ''} className={`logo__name ${isWhiteTheme ? 'logo__name--white' : ''}`} />
    </a>
    )
}
